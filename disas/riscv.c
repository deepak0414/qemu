...
const rv_opcode_data opcode_data[] = {
    ...
    { "sscheckra", rv_codec_none, rv_fmt_none, NULL, 0, 0, 0 },
    ...
    case 3:
        ...
        case 28:
            ...
            case 4:
                ...
                if ((((inst >> 15) & 0b10110011110000000) == 0b10000001110000000)) {
                    if ((inst >> 25) == 0b1000000) {
                        switch ((inst >> 20) & 0b11) {
                        case 0: /* sspush and sspop */
                            if (((inst >> 15) & 0b11111) && !((inst >> 7) & 0b11111))
                                op = rv_op_sspush;
                            if (!((inst >> 15) & 0b11111) && ((inst >> 7) & 0b11111))
                                op = rv_op_sspop;
                            break;
                ...
                } else if (((inst >> 15) & 0b10110010000000000) == 0b10000010000000000) { /* if matches mop_rr mask */
                    switch (inst >> 28) {
                    case 0b1000:
                        switch ((inst >> 7) & 0b11111) {
                        case 0b00000:
                            switch (((inst >> 23) & 0b11111)) { /* collect 5 bits */
                            case 23: op = rv_op_lpcul; break;
                            case 22: op = rv_op_lpsul; break;
                            case 13: op = rv_op_lpcml; break;
                            case 12: op = rv_op_lpsml; break;
                            case 6:
                            case 7:  op = rv_op_lpcll; break;
                            case 4:
                            case 5:  op = rv_op_lpsll; break;
                            default:
                                if (inst == 0b10001010000100101100000001110011) {
                                    op = rv_op_sscheckra;
                                } else {
                                    op = rv_op_zimops_rr;
                                }
                        ...
                        break;
                    default: op = rv_op_zimops_rr; break;
                    }
                }
                break;
