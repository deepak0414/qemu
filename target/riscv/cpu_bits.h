...
#define MSTATUS_SFCFIEN     0x01000000 /* Zisslpcfi-0.1 */
#define MSTATUS_MFCFIEN     0x02000000 /* Zisslpcfi-0.1 */
#define MSTATUS_UBCFIEN     0x04000000 /* Zisslpcfi-0.1 */
#define MSTATUS_SBCFIEN     0x08000000 /* Zisslpcfi-0.1 */
#define MSTATUS_SPELP       0x10000000 /* Zisslpcfi-0.1 */
#define MSTATUS_MPELP       0x20000000 /* Zisslpcfi-0.1 */
...
#define SSTATUS_SFCFIEN     MSTATUS_SFCFIEN /* Zisslpcfi-0.1 */
#define SSTATUS_UBCFIEN     MSTATUS_UBCFIEN /* Zisslpcfi-0.1 */
#define SSTATUS_SBCFIEN     MSTATUS_SFCFIEN /* Zisslpcfi-0.1 */
...
#define CFISTATUS_M_MASK    (MSTATUS_MFCFIEN | MSTATUS_SFCFIEN | \
                             MSTATUS_SBCFIEN | MSTATUS_UFCFIEN | \
                             MSTATUS_UBCFIEN | MSTATUS_MPELP | \
                             MSTATUS_SPELP)
#define CFISTATUS_S_MASK    (SSTATUS_SFCFIEN | SSTATUS_SBCFIEN | \
                             SSTATUS_UFCFIEN | SSTATUS_UBCFIEN | \
                             SSTATUS_SPELP)
